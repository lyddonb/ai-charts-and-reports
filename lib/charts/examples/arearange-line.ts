...
const areaRangeLineChartOptions: Options = {
  title: {
...
const AreaRangeLineChartExample: Example = {
  options: areaRangeLineChartOptions,
  name: 'Area Range Line Chart',
  chartType: 'arearange',
  slug: 'arearange-line-chart',
};

export default AreaRangeLineChartExample;
