...
const areaNegativeChartOptions: Options = {
  chart: {
    type: 'area',
  },
  title: {
...
const AreaNegativeChartExample: Example = {
  options: areaNegativeChartOptions,
  name: 'Area Negative Chart',
  chartType: 'area',
  slug: 'area-negative-chart',
};

export default AreaNegativeChartExample;
