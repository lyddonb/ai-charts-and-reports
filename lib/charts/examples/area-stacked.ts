...
const areaStackedChartOptions: Options = {
  chart: {
    type: 'area',
  },
  title: {
  ...
  series: [
    {
      ...
      data: [
        13234, 12729, 11533, 17798, 10398, 12811, 15483, 16196, 15060, 13365,
        13301,
      ],
    },
    {
...
const AreaStackedChartExample: Example = {
  options: areaStackedChartOptions,
  name: 'Area Stacked Chart',
  chartType: 'area',
  slug: 'area-stacked-chart',
};

export default AreaStackedChartExample;
