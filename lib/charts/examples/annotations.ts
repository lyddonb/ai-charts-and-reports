...
// We'll let the Chart component handle module loading instead of doing it here
// The annotations module will be loaded by loadHighchartsModules in chart.tsx
...
const annotationsOptions: Options = {
  chart: {
    type: 'area',
    zooming: {
      type: 'x',
  ...
  series: [
    {
      type: 'area',
      data: elevationData,
      lineColor: Highcharts.getOptions().colors?.[1] || '#7cb5ec',
      color: Highcharts.getOptions().colors?.[2] || '#434348',
      fillOpacity: 0.5,
      name: 'Elevation',
      marker: {
        enabled: false,
...
const AnnotationsExample: Example = {
