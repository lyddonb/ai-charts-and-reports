...
const threeDAreaMultipleOptions: Options = {
  chart: {
    type: 'area',
    options3d: {
      enabled: true,
...
const ThreeDAreaMultipleExample: Example = {
  options: threeDAreaMultipleOptions,
  name: '3D Area Multiple',
  chartType: 'area',
  slug: '3d-area-multiple',
};

export default ThreeDAreaMultipleExample;
